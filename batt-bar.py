...
import requests, simplejson as json, sys, time

#sudo pip3 install tenacity

#from tenacity import retry, stop_after_attempt, wait_combine, wait_fixed, wait_jitter
...
#@retry(wait=wait_combine(wait_fixed(10), wait_jitter(30)), stop=stop_after_attempt(5))
r = requests.session()

# URL to SolarEdge API
u = 'https://monitoringapi.solaredge.com/site/' + SE_SITE + '/currentPowerFlow?api_key=' + SE_AKEY
